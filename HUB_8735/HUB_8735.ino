    ...
    if (ObjDet.getResultCount() > 0) {
        ...
        for (int i = 0; i < ObjDet.getResultCount(); i++) {
            ...
            if (itemList[obj_type].filter) {
                ...
                if(strcmp(itemList[obj_type].objectName, "plasticbottle") == 0)
                {
                ...
                else if(strcmp(itemList[obj_type].objectName, "metalcan") == 0)
                {
                  for (pos = 0; pos <= 90; pos += 1) 
                  {
                    myservo2.write(pos);
                ...
                else if(strcmp(itemList[obj_type].objectName, "battery") == 0)
                {
                  for (pos = 0; pos <= 90; pos += 1) 
                  {
                    myservo3.write(pos);
